...
const HOST_INFO = { name: 'EvoFlux', version: '1.0.0' }
...
export function MCPAppResult({ mcpApp, sessionId, toolCallId }: MCPAppResultProps) {
  ...
  return (
    <div className={isFullscreen ? "fixed inset-0 z-(--z-modal) flex min-h-0 flex-col overflow-hidden bg-(--bg-page) [[data-mobile-shell]_&]:pt-[env(safe-area-inset-top)] [[data-mobile-shell]_&]:pb-[env(safe-area-inset-bottom)] [[data-mobile-shell]_&]:pl-[env(safe-area-inset-left)] [[data-mobile-shell]_&]:pr-[env(safe-area-inset-right)]" : 'flex flex-col gap-2'}>
