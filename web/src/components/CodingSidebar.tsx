              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <label className="block space-y-1 text-xs font-medium text-(--color-text-2)">
                  ...
                  <input
                    ...
                    maxLength={255}
                  />
                  <p className="text-[11px] font-normal text-(--color-text-subtle)">Blank defaults to EvoFlux/name.</p>
                </label>
              </div>
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="hidden gap-2 rounded-md border border-(--color-border) bg-(--bg-key)/30 px-3 py-2 text-[11px] leading-4 text-(--color-text-muted) sm:flex">
                  ...
                  <p>Stored in EvoFlux data, outside the source repo. Uncommitted source changes are not copied.</p>
                </div>
