...
function defineDarkTheme(monaco: Monaco) {
  defineThemeSafely(monaco, DARK_THEME, {
    ...
    colors: {
      'editor.background': themeColor('--bg-card', '#2D2C2A'),
      'editor.foreground': themeColor('--color-text-2', '#D9D5CF'),
      'editorLineNumber.foreground': themeColor('--color-text-subtle', '#A39D96'),
      'editorLineNumber.activeForeground': themeColor('--color-text-muted', '#B4AEA7'),
      'editor.selectionBackground': themeColor('--color-accent', '#A39D96', '26'),
      'editor.lineHighlightBackground': themeColor('--bg-key', '#383534', '80'),
      'editorCursor.foreground': themeColor('--color-text', '#F3F2EF'),
      'editorWidget.background': themeColor('--bg-card', '#2D2C2A'),
      'editorWidget.border': themeColor('--color-border', '#494540'),
      'input.background': themeColor('--bg-input', '#282725'),
      'input.border': themeColor('--color-border', '#494540'),
      'input.foreground': themeColor('--color-text', '#F3F2EF'),
      'scrollbarSlider.background': themeColor('--color-border', '#494540', '40'),
      'scrollbarSlider.hoverBackground': themeColor('--color-border', '#494540', '80'),
      'scrollbarSlider.activeBackground': themeColor('--color-border', '#494540', 'AA'),
      'editorGutter.background': themeColor('--bg-card', '#2D2C2A'),
      'minimap.background': themeColor('--bg-card', '#2D2C2A'),
    },
  })
}
...
function defineLightTheme(monaco: Monaco) {
  defineThemeSafely(monaco, LIGHT_THEME, {
    ...
    colors: {
      ...
      'editor.foreground': themeColor('--color-text-2', '#353535'),
      'editorLineNumber.foreground': themeColor('--color-text-subtle', '#6A6A6A'),
      'editorLineNumber.activeForeground': themeColor('--color-text-muted', '#5F5F5F'),
      'editor.selectionBackground': themeColor('--color-accent', '#575757', '26'),
      'editor.lineHighlightBackground': themeColor('--bg-key', '#EFEFEF', '80'),
      'editorCursor.foreground': themeColor('--color-text', '#1D1D1D'),
      'editorWidget.background': themeColor('--bg-card', '#FFFFFF'),
      'editorWidget.border': themeColor('--color-border', '#D8D8D8'),
      'input.background': themeColor('--bg-input', '#FFFFFF'),
      'input.border': themeColor('--color-border', '#D8D8D8'),
      'input.foreground': themeColor('--color-text', '#1D1D1D'),
      'scrollbarSlider.background': themeColor('--color-border', '#D8D8D8', '40'),
      'scrollbarSlider.hoverBackground': themeColor('--color-border', '#D8D8D8', '80'),
      'scrollbarSlider.activeBackground': themeColor('--color-border', '#D8D8D8', 'AA'),
