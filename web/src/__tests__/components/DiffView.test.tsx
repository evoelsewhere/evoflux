...
describe("DiffView", () => {
  it("renders edit tool diff correctly", () => {
    ...
    render(<DiffView toolName="edit" args={args} result={'@@ EvoFlux-diff-meta {"path":"src/main.py","old_start":42,"new_start":42}'} />)
  ...
  it("renders patch tool diff correctly", () => {
    ...
    render(
      <DiffView
        toolName="patch"
        args={args}
        result={'@@ EvoFlux-diff-meta {"files":[{"path":"src/utils.py","hunks":[{"old_start":17,"new_start":17}]}]}' }
      />,
    )
  ...
  it("renders patch hunks with their own line starts", () => {
    ...
    render(
      <DiffView
        toolName="patch"
        args={args}
        result={'@@ EvoFlux-diff-meta {"files":[{"path":"src/utils.py","hunks":[{"old_start":10,"new_start":10},{"old_start":20,"new_start":21}]}]}' }
      />,
    )
