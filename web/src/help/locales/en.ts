...
export const HELP_ARTICLES_EN: HelpArticle[] = [
  ...
  },
  {
    ...
    tricks: [
      ...
      'Open Recovery to preview a safe retry. It shows the phase transition, reused Spec/Plan/session identities, and preserved history before confirmation. Pre-implementation Runs can be explicitly continued in a compatible current Coding session; implementation and converged Runs cannot be rebound. A stale repository generation stops the retry.',
