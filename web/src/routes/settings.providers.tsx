      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        <div className="mx-auto max-w-3xl space-y-5 p-6">
          <p className="text-sm leading-relaxed text-(--color-text-muted)">
            Add the model provider EvoFlux should use. API keys are written to your local config; OAuth tokens are stored in your local cache. Click <span className="font-medium">List models</span> to verify a key before saving.
          </p>
