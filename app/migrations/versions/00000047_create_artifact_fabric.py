"""create Artifact Fabric control plane

Revision ID: 00000047
Revises: 00000046
...
revision: str = "00000047"
down_revision: Union[str, Sequence[str], None] = "00000046"
...
def downgrade() -> None:
    op.drop_index("ix_artifact_reviews_revision_created", table_name="artifact_reviews")
    op.drop_table("artifact_reviews")
    op.drop_index("ix_artifact_revisions_hash", table_name="artifact_revisions")
    op.drop_index("ix_artifact_revisions_job_created", table_name="artifact_revisions")
    op.drop_table("artifact_revisions")
    op.drop_index("ix_artifact_jobs_status_updated", table_name="artifact_jobs")
    op.drop_index("ix_artifact_jobs_session_created", table_name="artifact_jobs")
