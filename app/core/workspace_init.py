...
def ensure_workspace_initialized() -> None:
    ...
    if seed_result is not None:
        logger.info(
            ...
            len(seed_result.agents_written),
            len(seed_result.skills_written),
            len(seed_result.configs_written),
            seed_result.source,
            len(default_written),
            len(coding_written),
        )
    elif default_written or coding_written:
        logger.info(
