"""Cleanup helpers for generated EvoFlux artifacts."""
...
async def cleanup_generated_artifacts(
    ...
    *,
    ...
    workspace_root = Path(settings.EVOFLUX_WORKSPACE_DIR)
    ...
    state_root = Path(settings.EVOFLUX_STATE_DIR)
    for rel, reason in (
    ...
    sessions_root = Path(settings.EVOFLUX_DATA_DIR) / SESSIONS_DIR
