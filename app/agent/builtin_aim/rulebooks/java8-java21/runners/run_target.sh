#!/usr/bin/env bash
# Runs a migration unit's target (Java 21) implementation and writes its
...
echo "TODO: build (e.g. ./gradlew build or mvn -q package) and run the target (Java 21) for unit '$UNIT', case set '$CASE_SET'" >&2
