"""XLSX Artifact Fabric driver provided by the built-in Documents plugin."""
...
class XlsxArtifactDriver(ArtifactDriver):
    ...
    def catalog(self) -> dict[str, Any]:
        from app.agent.builtin_plugins.documents.engines.xlsx import workbook_catalog
    ...
    async def inspect(self, context: ArtifactDriverContext) -> ArtifactDriverResult:
        from app.agent.builtin_plugins.documents.engines.xlsx import inspect_xlsx
    ...
    async def validate(self, context: ArtifactDriverContext) -> ArtifactDriverResult:
        from app.agent.builtin_plugins.documents.engines.xlsx import (
