...
mark_chapter = Tool(
    ...
    description=(
        ...
        "between topics. Call before the first search or exploration step of a "
        "substantial new request, and when work shifts to a meaningfully different "
        "phase. Do not call it for every individual tool invocation."
    ),
)
