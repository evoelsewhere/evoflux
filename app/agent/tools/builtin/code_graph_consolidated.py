...
This module consolidates the original 7 code graph tools into 4 simpler,
more effective tools:

1. code_search  — Unified search + symbol lookup (replaces code_search + code_symbol)
2. code_graph   — Unified relationship view (replaces code_neighbors + code_references)
3. code_overview — Unified overview + ranking (replaces code_overview + code_map)
4. code_path    — Shortest path (unchanged)

Benefits:
- 43% fewer tools (7 → 4)
- 71% fewer parameters (21+ → 6)
- Auto-detect scope (no manual scope parameter)
...
# ═══════════════════════════════════════════════════════════════════════════════
# Tool 4: code_path — Shortest path (unchanged)
# ═══════════════════════════════════════════════════════════════════════════════
...
# Export all consolidated tools
CONSOLIDATED_TOOLS = [search_tool, graph_tool, overview_tool, path_tool]
