...
| Edit or create from template | Read `{SKILL_DIR}/editing.md` |
| Create from scratch | Read `{SKILL_DIR}/pptxgenjs.md` |
...
**Read `{SKILL_DIR}/editing.md` for full details.**
...
**Read `{SKILL_DIR}/pptxgenjs.md` for full details.**
