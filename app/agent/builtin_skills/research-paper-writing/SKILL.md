...
description: "Use this skill to draft, rewrite, or review an academic paper in machine-learning, vision, or language-processing style: abstract, introduction, related work, method, experiments, conclusion, rebuttal-facing revision, figure and table formatting, LaTeX builds, and adversarial pre-submission review. Apply it when a paper or its LaTeX source is the artifact. Do not use it for general professional prose, product documentation, or literature gathering with no paper to produce."
---
