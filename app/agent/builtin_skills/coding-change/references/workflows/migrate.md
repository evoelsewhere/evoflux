...
workflow: migrate
owner: coding-change
description: Use this workflow for compatibility-sensitive transitions across APIs, schemas, storage, frameworks, packages, modules, deployments, or repositories when old and new contracts must coexist or rollout order matters. It defines staged change, verification, rollback, and cleanup; do not use it for an atomic internal refactor or a focused feature that can ship in one compatible change.
---
