...

    {
      ...
      "platforms": {
        "darwin-aarch64": {
          ...
          "url": "https://.../EvoFlux.app.tar.gz"
        },
        "linux-x86_64": {
          "signature": "<.sig contents>",
          "url": "https://.../EVOFLUX_0.6.0_amd64.AppImage"
        }
      }
    }
...
def _release_base_url(version: str, tag: str) -> str:
    repo = os.environ.get("GITHUB_REPOSITORY", "khuonghung/evoflux")
...
def main() -> int:
    ...
    manifest = {
        ...
        "notes": f"EvoFlux Desktop {args.version} — see release notes on GitHub.",
        "platforms": platforms,
    }
