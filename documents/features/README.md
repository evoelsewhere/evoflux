...
| Evo Agent Specs | Implemented | Repository-owned **Agent Specification-Driven Development** with common accepted-Spec catalogue, optional living knowledge sections, user-approved direct/planned flow, Review, Verify and Converge | EASD repository store/setup/run services and API, team runtime and `EvoAgentSpecsPanel.tsx` | [Evo Agent Specs](evo-agent-specs.md) |
