...
Context engineering is how EvoFlux controls what the LLM sees on each call: which messages survive, how the system prompt is shaped, and how per-run data flows through the agent.
