...
def set_EVOFLUX_dirs(monkeypatch: pytest.MonkeyPatch, root: Path) -> None:
    ...
    """
    monkeypatch.setenv("EVOFLUX_DATA_DIR", str(root / "data"))
    monkeypatch.setenv("EVOFLUX_CONFIG_DIR", str(root / "config"))
    monkeypatch.setenv("EVOFLUX_STATE_DIR", str(root / "state"))
    monkeypatch.setenv("EVOFLUX_CACHE_DIR", str(root / "cache"))
