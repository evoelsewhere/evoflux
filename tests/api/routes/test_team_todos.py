...
def _isolate_data_dir(tmp_path, monkeypatch):
    ...
    Session todos live under ``EVOFLUX_DATA_DIR/sessions/<sid>``; without
...
def todos_path(root, session_id: str):
    ...
    ``EVOFLUX_DATA_DIR/sessions/<sid>/.todos.json`` — independent of the
    ...
    path = Path(settings.EVOFLUX_DATA_DIR) / "sessions" / session_id / TODOS_FILENAME
