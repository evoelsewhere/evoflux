...
def _point_EVOFLUX_at(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> Path:
    ...
    monkeypatch.setattr(
        _config.settings, "EVOFLUX_STATE_DIR", str(tmp_path), raising=True
    )
